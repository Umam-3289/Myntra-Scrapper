...
class DashboardGenerator:
    ...
    def display_general_info(self):
        ...
        # Convert overall Rating and Price columns to numeric
        ...
        #Summary of pie chart of average rating by product
        product_ratings=self.data.groupby('Product Name',as_index=False)['Over_All_Rating'].mean().dropna()
        fig_pie=px.pie(product_ratings,values='Over_All_Rating',names='Product Name',title='Average Rating By Product')
    ...
    def display_product_session(self):
